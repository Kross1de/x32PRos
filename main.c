...
main(struct multiboot *mboot_ptr) {
        ...
        int *some_ints = (int *)kmalloc(sizeof(int) * 50);
        kprintf("Herp derp.\n");
        int j;
        for (j = 0; j < 50; ++j) {
                some_ints[j] = 50;
        ...
        char *some_chars = (char *)kmalloc(sizeof(char) * 4);
        for (j = 0; j < 4; ++j) {
                some_chars[j] = 'a';
        }
        ...
        free(some_chars);
        free(some_ints);
        char *a_string = (char *)kmalloc(sizeof(char) * 6);
        a_string[0] = 'h';
        a_string[1] = 'e';
        a_string[2] = 'l';
        a_string[3] = 'l';
        ...
        a_string = (char *)kmalloc(sizeof(char) * 6);
        a_string[0] = '1';
        a_string[1] = '2';
        a_string[2] = '3';
        a_string[3] = '\0';
